...
Preprocesses a single MNI152-space fMRIPrep output file for ICA estimation.
Includes spatial smoothing (4mm FWHM) and bandpass filtering (0.01–0.1 Hz).

Usage:
    python preprocess_ica.py <func_file> <mask_file> <output_dir>
...
def main():
    if len(sys.argv) < 4:
        print("Usage: python preprocess_ica.py <func_file> <mask_file> <output_dir>")
        sys.exit(1)
